...
* Multiple images of the object are taken from different angles.
* Computer vision algorithms identify common features across images.
* The 3-D structure is reconstructed by triangulating the positions of these features in space.

:::

::: {.column}

![Example of photogrammetry reconstruction](https://blog.prusa3d.com/wp-content/uploads/2018/03/epipolar_geometry.jpg)
...
* The device emits a pulse or modulated beam of light.
* Distance is computed from the return time or phase shift.
...
Time-of-flight devices are fast and portable, but their resolution and edge accuracy are usually lower than close-range photogrammetry or structured light scanning for small artefacts.
...
* A laser scanner measures distance and angle for many points across a scene.
* Scans are aligned using targets, shared geometry, SLAM, GNSS, or total-station control.
